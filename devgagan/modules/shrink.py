...
async def token_handler(client, message):
    ...
    if len(message.command) <= 1:
        image_url = "https://i.postimg.cc/FHXKwcht/Shelby-on-top.jpg"
        join_button = InlineKeyboardButton("Join Channel", url="https://t.me/team_shellby_limited")
        premium = InlineKeyboardButton("💬 OWNER CONTACT", url="https://t.me/Zapadiya_milan_003")   
        ...
        await message.reply_photo(
           # msg.photo.file_id,
            ...
            caption=(
                 ...
                 " 🔏 Fetch Any Restriction or Private Chennal & Groups..\n"
                 " CONTENT - VIDEO, FILES, PHOTO, PDFs, TEXT , ETC...\n\n"
                     
                 "✳️ I Can Save Post From Chennal Or Groups Where Forwarding Is Off. I Can Download Videos/ Audios From YT, INSTA, ... Social Platforms..\n"
