...
async def terms(client, message):
    ...
    buttons = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("💬 Contact Now", url="https://t.me/Zapadiya_milan_003")],
        ]
    )
...
async def plan(client, message):
    plan_text = (
       ...
       # "   - Users are advised to wait for the process to automatically cancel before proceeding with any downloads or uploads.\n\n"
        ...
        "━━━━━━━━━━━━━━━━━━━━\n\n"
        "💳 Premium Pricing:\n\n"
        "🏆 1 Day Pro Plan: ₹30 (For 1 Days)\n\n"
        "🏆 Weekly Pro Plan: ₹130 (For 7 Days)\n\n"
        "🏆 Fortnightly Pro Plan: ₹200 (For 15 Days)\n\n"
        "🏆 Monthly Pro Plan: ₹250 (For 30 Days)\n\n"
        "🏆 Yearly Pro Plan: ₹1500 (For 365 Days)\n\n"
