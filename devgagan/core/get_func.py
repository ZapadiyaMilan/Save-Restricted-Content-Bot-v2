...
class SmartTelegramBot:
        ...
        try:
            ...
            if free_check == 1:
                ...
                reply_markup = InlineKeyboardMarkup([[
                    InlineKeyboardButton("💎 Get Premium to Forward", url="https://t.me/Zapadiya_milan_003")
                ]])
    ...
    async def send_settings_panel(self, chat_id: int, user_id: int):
        ...
        buttons = [
            ...
            [Button.inline("🗑️Remove Words", b'delete'), Button.inline("♻️Reset All", b'reset')],
